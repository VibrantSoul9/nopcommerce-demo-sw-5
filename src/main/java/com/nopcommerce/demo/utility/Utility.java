...
public class Utility extends ManageBrowser {
    /**
     * Utility class extends to ManageDriver for the driver to find locators
    ...
    public void sendTextElement(WebElement element, String str) {
    ...
    /**
     * Thsi method will send text to alert
     */
    ...
    /**
     * This meethod will select the option by value
     */
...
public WebElement waitForElementWithFluentWait(By by, int time, int pollingTime){
    Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(time)).pollingEvery(Duration.ofSeconds(pollingTime)).ignoring(NoSuchElementException.class);
...
//***********************Is Display methods*************************************//
    ...
    public boolean verigyThatTextIsDisplayed(WebElement element, String text){
        if (text.equals(element.getText())){
            return true;
        } else {
            return false;
    ...
    public ArrayList<String> getArrayListOfStringFromWebElements(List<WebElement> listOfElements) {
